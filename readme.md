...
- [unoDynamicUI/Presentation/MainViewModel.cs](unoDynamicUI/Presentation/MainViewModel.cs): 導航到模板頁與預設 JSON
...
3. 點擊 Open Template Page (From JSON)。
4. 在 Dynamic Template Page 點擊 Reload JSON，可重新生成欄位。
5. 填寫表單後點擊 Confirm：
